...
class DecisionTreeClassifierTest {
    ...
    private DecisionTreeClassifier algorithm;
    private ObjectMapper objectMapper;

    @BeforeEach
    void setUp() throws Exception {
        objectMapper = new ObjectMapper();
        algorithm = new DecisionTreeClassifier(objectMapper);
    ...
    void metadata() {
        assertEquals("决策树分类器", algorithm.getAlgorithmName());
        assertEquals("DECISION_TREE_CLASSIFIER", algorithm.getAlgorithmType());
    ...
    void getAlgorithmParams() {
        ...
        assertEquals("DECISION_TREE_CLASSIFIER", params.get("algorithm"));
        assertEquals(4, params.get("maxDepth"));
        assertEquals(2, params.get("minSamplesSplit"));
